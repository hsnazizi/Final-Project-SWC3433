...
<div class="content">
  <div class="page-title">
    <h1>Cozy Little Retreat.</h1>
  </div>

<div class="content-container content-layout">
<div class="left-collumn">
	<div class="house1-images">
	<img class="clickable-img" src="houses/1.jpg" alt="House" style="width:100%;max-width:200px">
	<img class="clickable-img" src="houses/1/room 1.jpg" alt="Room 1" style="width:100%;max-width:200px">
	<img class="clickable-img" src="houses/1/room 2.jpg" alt="Room 2" style="width:100%;max-width:200px">

	<div style="flex-basis: 100%; height: 0;"></div>
	<img class="clickable-img" src="houses/1/living room.jpg" alt="Living Room" style="width:100%;max-width:200px;">
	<img class="clickable-img" src="houses/1/kitchen.jpg" alt="Kitchen" style="width:100%;max-width:200px;">
	<img class="clickable-img" src="houses/1/toilet.jpg" alt="Toilet" style="width:100%;max-width:200px;">
	</div>

	<div class="info-box">
		<h1>About this space</h1>
		<h2 class="text-muted">RM250/night <br> 6 guests | 2 bedrooms | 3 beds | 1 bath</h2>    
		<p>Escape to the perfect sanctuary at Rening 46, Kg Hulu Rening, Batang Kali. Indulge in cozy accommodation and a welcoming atmosphere.
			Perfect place for weekend get away. Surrounded with lush greenery and walking distance to pristine Sg Rening.<span id="dots">...</span><span id="more">
			Less than 1 min of walk to Sg Rening
			5-7 mins of walking to Dusun Tok Mat Atv ride ( tour around Kg Hulu Rening area)
			30 mins to Kuala Kubu Baru (Sg Chilling, Paragliding, Zipline, KKB Dam, Bukit Kutu, white water rafting)
			10 mins to Hulu Tamu Hot Spring</span></p>
