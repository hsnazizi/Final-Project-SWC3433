...
.booking-form {
    ...
    width: 100%;
    max-width: 450px; /* Limits form width to avoid overflow */
}
...
<header>
    <nav>
      <img class="logo-img" src="LOGO.png" alt="GetAway Logo">
        <h1><strong>GetAway</strong></h1>
        <div>
            <a href="Accomodations Listings.html"><b>ACCOMODATIONS</b></a>
            <div class="dropdown">
              <a href="#" class="dropbtn"><b>LOGIN</b></a>
              <div class="dropdown-content">
                  <a href="Get Away - Login.html">USER</a>
                  <a href="Get Away - Login.html">ADMIN</a>
              </div>
          </div>
